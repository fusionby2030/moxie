...
def normalize_profiles(profiles, mu_T=None, var_T=None, mu_D=None, var_D=None):
    profiles[:, 0], mu_D, var_D = standardize_simple(profiles[:, 0], mu_D, var_D)
    profiles[:, 1], mu_T, var_T = standardize_simple(profiles[:, 1], mu_T, var_T)
    return profiles, mu_T, var_T, mu_D, var_D
