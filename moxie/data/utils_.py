...
def load_data(dataset_choice='SANDBOX_NO_VARIATIONS', file_loc='/home/kitadam/ENR_Sven/moxie/data/processed/pedestal_profiles_ML_READY_ak_19042022.pickle'):
    ...
    with open(file_loc, 'rb') as file:
        ...
        return (train_X, train_y, train_mask, train_radii, train_real_space_radii, train_ids), (val_X, val_y, val_mask, val_radii, val_real_space_radii, val_ids), (test_X, test_y, test_mask, test_radii, test_real_space_radii, test_ids)