...
class DIVA_v2(BaseVAE):
    ...
    def __init__(self, in_ch: int = 2, out_dim: int = 63,
        ...
        self.encoder_end_dense_size = 128
        ...
        self.encoder_end = nn.Linear(2*(self.hidden_dims[-1] * end_conv_size), 128)
        ...
        self.final_layer_n = nn.Linear(final_size, 63)
        self.final_layer_t = nn.Linear(final_size, 63)
    ...
    def loss_function(self, *args, **kwargs) -> Tensor:
        ...
        # print(in_profs)
        # print(out_profs)
        # print(in_profs.shape, out_profs.shape)
